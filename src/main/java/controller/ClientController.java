...
public class ClientController {
    ...
    @FXML
    private TableView<Client> tableCustomersPage;
    ...
    public void listCustomers() {
        ...
        Task<ObservableList<Client>> getAllCustomersTask = new Task<ObservableList<Customer>>() {
            @Override
    ...
    private void addActionButtonsToTable() {
        ...
        Callback<TableColumn<Client, Void>, TableCell<Client, Void>> cellFactory = new Callback<TableColumn<Customer, Void>, TableCell<Customer, Void>>() {
            @Override
                ...
                return new TableCell<Client, Void>() {
                    ...
                    private final Button viewButton = new Button("View");
                    {
                        ...
                        viewButton.setOnAction((ActionEvent event) -> {
                            Client customerData = getTableView().getItems().get(getIndex());
...
//                        buttonsPane.getChildren().add(editButton);
    ...
    public void btnCustomersSearchOnAction() {
        Task<ObservableList<Client>> searchCustomersTask = new Task<ObservableList<Customer>>() {
            @Override
            protected ObservableList<Client> call() {
    ...
    private void fillEditCustomer(int customer_id) {
        ...
        Task<ObservableList<Client>> fillCustomerTask = new Task<ObservableList<Customer>>() {
            @Override
            protected ObservableList<Client> call() {
                return FXCollections.observableArrayList(
